...
import static page.foliage.guava.common.base.Predicates.compose;
...
import page.foliage.guava.common.collect.MapDifference.ValueDifference;
...
public final class Maps {
   ...
   *
   * <pre>{@code
   * import static page.foliage.guava.common.collect.ImmutableMap.toImmutableMap;
   * ...
   * ImmutableMap<String, Color> colorForName =
   ...
   * page.foliage.guava.common.base.Functions#forMap(Map)} or {@link
   * page.foliage.guava.common.base.Functions#forMap(Map, Object)}.
   *
   * @since 16.0
   */
