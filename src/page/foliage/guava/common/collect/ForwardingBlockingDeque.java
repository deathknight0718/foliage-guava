 ...
 * @author Emily Soldal
 * @since 14.0
 * @deprecated This class has moved to {@code page.foliage.guava.common.util.concurrent}. Please use {@link
 *     page.foliage.guava.common.util.concurrent.ForwardingBlockingDeque} instead.
 */
@Deprecated
@J2ktIncompatible
@GwtIncompatible
