...
public abstract class Optional<T> implements Serializable {
  ...
  /**
   * Returns the equivalent {@code page.foliage.guava.common.base.Optional} value to the given {@code
   ...
   * page.foliage.guava.common.base.Optional}, or {@code null} if the argument is null.
   *
