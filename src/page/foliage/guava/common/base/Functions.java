...
/**
 * Static utility methods pertaining to {@code page.foliage.guava.common.base.Function} instances; see that
...
public final class Functions {
   ...
   *
   * <p>Note: if {@code map} is a {@link page.foliage.guava.common.collect.BiMap BiMap} (or can be one), you
   * can use {@link page.foliage.guava.common.collect.Maps#asConverter Maps.asConverter} instead to get a
