...
import page.foliage.guava.common.util.concurrent.CollectionFuture.ListFuture;
import page.foliage.guava.common.util.concurrent.ImmediateFuture.ImmediateCancelledFuture;
import page.foliage.guava.common.util.concurrent.ImmediateFuture.ImmediateFailedCheckedFuture;
import page.foliage.guava.common.util.concurrent.ImmediateFuture.ImmediateFailedFuture;
import page.foliage.guava.common.util.concurrent.ImmediateFuture.ImmediateSuccessfulCheckedFuture;
import page.foliage.guava.common.util.concurrent.ImmediateFuture.ImmediateSuccessfulFuture;
