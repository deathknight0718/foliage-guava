...
import page.foliage.guava.common.util.concurrent.ForwardingListenableFuture.SimpleForwardingListenableFuture;
...
public final class MoreExecutors {
  ...
  public static ThreadFactory platformThreadFactory() {
    ...
    try {
      return (ThreadFactory)
          Class.forName("page.foliage.guava.appengine.api.ThreadManager")
  ...
  private static boolean isAppEngineWithApiClasses() {
    if (System.getProperty("page.foliage.guava.appengine.runtime.environment") == null) {
      return false;
    }
    try {
      Class.forName("page.foliage.guava.appengine.api.utils.SystemProperty");
    } catch (ClassNotFoundException e) {
      return false;
    }
    try {
      // If the current environment is null, we're not inside AppEngine.
      return Class.forName("page.foliage.guava.apphosting.api.ApiProxy")
