...
import static page.foliage.guava.common.util.concurrent.ExecutionSequencer.RunningState.CANCELLED;
import static page.foliage.guava.common.util.concurrent.ExecutionSequencer.RunningState.NOT_RUN;
import static page.foliage.guava.common.util.concurrent.ExecutionSequencer.RunningState.STARTED;
import static page.foliage.guava.common.util.concurrent.Futures.immediateCancelledFuture;
import static page.foliage.guava.common.util.concurrent.Futures.immediateFuture;
import static page.foliage.guava.common.util.concurrent.Futures.immediateVoidFuture;
