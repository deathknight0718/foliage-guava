...
import static page.foliage.guava.common.util.concurrent.NullnessCasts.uncheckedNull;
 ...
 * page.foliage.guava.common.base.Function, java.util.concurrent.Executor) Futures.transform} and {@link
 * Futures#catching(ListenableFuture, Class, page.foliage.guava.common.base.Function,
...
public abstract class AbstractFuture<V extends @Nullable Object> extends InternalFutureFailureAccess
   ...
   * page.foliage.guava.common.util.concurrent.SettableFuture} do not expose it to their users as an
  ...
  public String toString() {
    ...
    if (getClass().getName().startsWith("page.foliage.guava.common.util.concurrent.")) {
